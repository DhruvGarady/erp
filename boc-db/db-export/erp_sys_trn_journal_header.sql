...
--
-- Table structure for table `trn_journal_header`
--

DROP TABLE IF EXISTS `trn_journal_header`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trn_journal_header` (
  `journal_header_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `trn_journal_header`
--

LOCK TABLES `trn_journal_header` WRITE;
/*!40000 ALTER TABLE `trn_journal_header` DISABLE KEYS */;
/*!40000 ALTER TABLE `trn_journal_header` ENABLE KEYS */;
UNLOCK TABLES;
